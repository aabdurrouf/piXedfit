...
from piXedfit.utils.filtering import match_filters_array, filtering_match_filters_array
...
# for fixed redshift, match wavelength points of transmission curves with the spectrum at the given redshift
global trans_fltr_int
redsh_wave = f['mod/spec/wave'][:]*(1.0+gal_z)
