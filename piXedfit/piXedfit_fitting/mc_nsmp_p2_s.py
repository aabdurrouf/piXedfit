...
def store_to_fits(nsamples=None,sampler_params=None,sampler_log_sfr=None,sampler_log_mw_age=None,
	...
	if rank == 0:
		...
		cols = fits.ColDefs(cols0)
		hdu3 = fits.BinTableHDU.from_columns(cols, name='bfit_mod_spec')
		...
		cols = fits.ColDefs(cols0)
		hdu4 = fits.BinTableHDU.from_columns(cols, name='chimin_spec')
		...
		cols = fits.ColDefs(cols0)
		hdu6 = fits.BinTableHDU.from_columns(cols, name='bfit_mod')
